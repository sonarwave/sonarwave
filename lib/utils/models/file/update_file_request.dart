...
UpdateFileRequest updateFileRequestFromJson(String str) => UpdateFileRequest.fromJson(json.decode(str));

String updateFileRequestToJson(UpdateFileRequest data) => json.encode(data.toJson());
...
abstract class UpdateFileRequest with _$UpdateFileRequest {
    ...
    factory UpdateFileRequest.fromJson(Map<String, dynamic> json) => _$UpdateFileRequestFromJson(json);
}